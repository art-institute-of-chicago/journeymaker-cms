CKEDITOR.plugins.add( 'learninglens',
{
	init : function( editor )
	{
		// Add the link and unlink buttons.
		editor.addCommand( 'annotate', new CKEDITOR.dialogCommand( 'annotate' ) );
		editor.addCommand( 'unannotate', new CKEDITOR.removeAnnotationCommand() );
		editor.ui.addButton( 'Annotation',
			{
				label : 'Annotation',
				command : 'link'
			} );
		editor.ui.addButton( 'Remove Annotation',
			{
...
CKEDITOR.plugins.annotate =
{
	 ...
	 * </pre>
	 */
	getSelectedSpan : function( editor )
	{
		try
		{
...
CKEDITOR.removeAnnotationCommand = function(){};
CKEDITOR.removeAnnotationCommand.prototype =
{
	/** @ignore */
	exec : function( editor )
	{
		...
		editor.document.$.execCommand( 'unannotate', false, null );
